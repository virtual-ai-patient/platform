...
class CasesApi {
  ...
  Future<Response<BuiltList<CaseResponse>>> listCasesCasesGet({
    ...
    // Omit optional query param when unset — encodeQueryParameter(null) becomes '' and
    ...
    BuiltList<CaseResponse>? _responseData;
    ...
    return Response<BuiltList<CaseResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
