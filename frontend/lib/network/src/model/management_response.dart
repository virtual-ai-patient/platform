...
part 'management_response.g.dart';
...
class _$ManagementResponseSerializer implements PrimitiveSerializer<ManagementResponse> {
  ...
  @override
  final String wireName = r'ManagementResponse';
  ...
  void _deserializeProperties(
    ...
    required ManagementResponseBuilder result,
  ...
  @override
  ManagementResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ManagementResponseBuilder();
